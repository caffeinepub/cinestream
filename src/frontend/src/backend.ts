...
export class Backend implements backendInterface {
    ...
    async addTrackedShow(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTrackedShow(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLastVisit(): Promise<Time | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLastVisit();
    ...
    async getTrackedShows(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrackedShows();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTrendingMovies(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
    ...
    async getTrendingTVShows(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrendingTVShows();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeTrackedShow(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeTrackedShow(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLastVisit(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLastVisit();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTrendingMovies(arg0: Array<[string, string]>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTrendingMovies(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTrendingTVShows(arg0: Array<[string, string]>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTrendingTVShows(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
